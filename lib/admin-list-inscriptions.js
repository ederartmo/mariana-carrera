...
const ADMIN_COLUMNS =
  'id, full_name, email, buyer_email, order_session_id, stripe_session_id, ticket_index, ticket_count, event_slug, distance, amount_paid, payment_status, registration_status, cancellation_type, bib_number, cancelled_bib_number, cancelled_at, cancelled_by, cancellation_reason, shirt_size, birth_date, whatsapp, state, borough, email_sent, created_at';
