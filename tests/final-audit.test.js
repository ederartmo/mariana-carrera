...
test('B10-auth: admin server-side autoritativo, sin flags browser', () => {
  ...
  for (const file of ['api/admin-delete-inscription.js', 'api/admin-manual-transfer.js', 'api/admin-update-participant.js', 'api/admin-update-inscription-email.js', 'lib/admin-cancel-registration.js', 'lib/admin-update-manual-payment-status.js', 'api/resend-confirmations.js', 'api/resend-single-confirmation.js', 'lib/resend-emails-list.js']) {
