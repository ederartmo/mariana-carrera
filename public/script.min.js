...
function setupUnifiedFooter() {
  ...
  if (grid) {
    grid.innerHTML = `
      <div>
        <div class="footer-brand-block">
          ...
          <div class="footer-social" aria-label="Redes sociales de Kinetic Hub">
            <a style="display:flex; justify-content:center; align-items:center" class="footer-social-link" href="https://wa.me/525530790944?text=Hola%2C%20quiero%20informaci%C3%B3n%20de%20Kinetic%20Hub" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
            ...
            <a style="display:flex; justify-content:center; align-items:center" class="footer-social-link" href="https://www.instagram.com/kinetic.hub" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a style="display:flex; justify-content:center; align-items:center" class="footer-social-link" href="https://www.facebook.com/profile.php?id=100065314880446&mibextid=wwXIfr&rdid=KDtMnE3lJn9aQZkB&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F18ER76xC2i%2F%3Fmibextid%3DwwXIfr#" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <a style="display:flex; justify-content:center; align-items:center" class="footer-social-link" href="https://www.tiktok.com/@kinetic.hub" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
      ...
      <div>
        <h3>Newsletter</h3>
        <p>Te notificamos próximas carreras, aperturas, resultados y novedades de la comunidad.</p>
...
function setupFooterNewsletter() {
  ...
  forms.forEach((form) => {
    ...
    form.addEventListener("submit", async (event) => {
      ...
      if (confirmationSent) {
        status.textContent = "Gracias por registrarte. Te enviamos un correo de confirmación.";
      } else {
        ...
        const openRegisterModal = () => {
          ...
          overlay.innerHTML = `
            <div class="profile-race-register-modal" role="dialog" aria-modal="true" aria-labelledby="profileRaceRegisterTitle">
              <button class="profile-race-register-close" type="button" aria-label="Cerrar">×</button>
...
function setupChecklistPaymentStatus() {
  ...
  const applyCompletedState = () => {
    ...
    desc.textContent = "Tu inscripción ya está pagada. Revisa tu correo para los siguientes pasos.";
    btn.textContent = "Pago completado";
    btn.classList.remove("cl-btn-orange");
    btn.classList.add("cl-btn-dark", "is-disabled");
